 ...
 */
export declare type SnackFile = SnackCodeFile | SnackAssetFile;
/**
 ...
 */
export declare type SnackCodeFile = {
    type: 'CODE';
    contents: string;
    error?: Error;
};
 ...
 */
export declare type SnackAssetFile = {
    type: 'ASSET';
 ...
 */
export declare type SnackFiles = {
    [path: string]: SnackFile;
};
/**
 * Dictionary of dependencies and their version.
 */
export declare type SnackDependencyVersions = {
    [name: string]: string;
};
/**
 ...
 */
export declare type SnackDependency = {
    version: string;
    handle?: string;
 ...
 */
export declare type SnackDependencies = {
 ...
 */
export declare type SnackMissingDependency = {
    dependents: string[];
    wantedVersion?: string;
};
/**
 ...
 */
export declare type SnackMissingDependencies = {
